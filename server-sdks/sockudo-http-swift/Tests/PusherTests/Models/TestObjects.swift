...
struct TestObjects {
  ...
  struct Client {
    ...
    static let shared = Pusher(
      options: try! PusherClientOptions(
        appId: testAppId,
        key: testKey,
        secret: testSecret,
  ...
  struct ClientOptions {
    ...
    static let withCluster = try! PusherClientOptions(
      appId: testAppId,
      key: testKey,
      secret: testSecret,
    ...
    static let withCustomHost = try! PusherClientOptions(
      appId: testAppId,
      key: testKey,
      secret: testSecret,
      encryptionMasterKey: testEncryptionMasterKey,
    ...
    static let withCustomPort = try! PusherClientOptions(
      appId: testAppId,
      key: testKey,
      secret: testSecret,
      encryptionMasterKey: testEncryptionMasterKey,
    ...
    static let withInvalidMasterKey = try! PusherClientOptions(
      appId: testAppId,
      key: testKey,
      secret: testSecret,
    ...
    static let withInvalidPrefixHost = try! PusherClientOptions(
      appId: testAppId,
      key: testKey,
      secret: testSecret,
      encryptionMasterKey: invalidEncryptionMasterKey,
    ...
    static let withInvalidSuffixHost = try! PusherClientOptions(
      appId: testAppId,
      key: testKey,
      secret: testSecret,
      encryptionMasterKey: invalidEncryptionMasterKey,
  ...
  struct Webhooks {
    ...
    private static func webhookRequest(
      ...
      pusherSignatureHeaderValue: String? = Client.testSecret
    ) -> URLRequest {
      ...
      if pusherSignatureHeaderValue != nil, request.httpBody != nil {
        let signature = CryptoService.sha256HMAC(
          ...
          using: pusherSignatureHeaderValue!.toData()
        ).hexEncodedString()
